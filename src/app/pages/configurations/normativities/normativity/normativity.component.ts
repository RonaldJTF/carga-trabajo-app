...
export class NormativityComponent implements OnInit {
  ...
  assignValuesToForm(){
    ...
    this.formNormativity.get('fechaInicioVigencia').setValue(new Date(this.normativity.fechaInicioVigencia));
    this.formNormativity.get('fechaFinVigencia').setValue(new Date(this.normativity.fechaFinVigencia));
  }
