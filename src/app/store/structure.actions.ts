...
export const setDependency = createAction('[Configuration of Structures]  Set the dependency', props<{ structure: Structure, hasLoadedInformation: boolean }>());
...
export const updateItemIntoList = createAction('[Configuration of Structures] Update content of updated item in list', props<{ structure: Structure }>());
