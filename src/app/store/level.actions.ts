...
export const updateFromList = createAction('[Configuration of Level] Update an item in list', props<{ level: Level }>());
...
export const updateSalaryScalesToLevel = createAction('[Configuration of Level] Update the salary scales to item in list', props<{ levelId: number, salaryScales: SalaryScale[] }>());
export const removeSalaryScaleToLevel = createAction('[Configuration of Level] Remove a salary scale by id to a level in list', props<{ salaryScaleId: number }>());
